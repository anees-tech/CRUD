  ...
  return (
    <div>
      ...
      <div className="mb-6 w-1/2 mx-auto px-6 mt-5 bg-neutral-800 rounded-xl py-5 ">
        <h1 className=" text-2xl font-bold mb-5 text-center text-gray-200">Add Student</h1>
        {inputFields.map((item, index) => {
          return (
            <div key={index} className=" w-full mt-3 mx-2">
              ...
              <input type={item.inputType} id="default-input" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder={item.inputPlaceHolder} />
            </div>
          )
        })}
